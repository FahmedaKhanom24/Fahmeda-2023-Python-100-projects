...
userinput = input("You are in a park, which direction you want to go? Tyep 'L' for left and 'R' for right ").upper()
if userinput == 'L':
    userinput2= input("Do you want to swim('S') or wait('W')?").upper()
    if userinput2 == 'W':
        userinput3=input("Which door Red('R'), Blue('B'), Yellow('Y') or anything?").upper()
        if userinput3=='R':
